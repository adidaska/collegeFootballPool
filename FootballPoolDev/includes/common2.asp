<%	'this is the dev version
	...
	const POOL_URL = "http://www.dessmachine.com/FootballPoolDev"

	'Page title.
	const PAGE_TITLE = "JAFL - Just Another Football League"

	'Administrator email address.
	const ADMIN_EMAIL = "adidaska@megstudios.com" '"bwr@coloneybell.com"
	...
	const TIME_ZONE_DIFF = -2

	'Location of the database.
	const DATABASE_FILE_PATH = "../access_db/NCAAdev.mdb"
	...
	'Classes for handling the breaking of the tiebreaker into multiple fields
	Class TBclass
		Public VisScore
		Public HomeScore
		Public diff
	...
	sub OpenDB()
        ...
        db_server = "jafldb.db.2100866.hostedresource.com"
        db_name = "jafldb"
        db_username = "jafldb"
        db_userpassword = "Flipper12#"
